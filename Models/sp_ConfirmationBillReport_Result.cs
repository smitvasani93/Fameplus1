...
namespace Transactiondetails.Models
{
    ...
    public partial class sp_ConfirmationBillReport_Result
    {
        ...
        public Nullable<double> JDNoChargeQuantity { get; set; }
        public Nullable<System.DateTime> JRRefDate { get; set; }
        public Nullable<double> JRItemPieces { get; set; }
        public Nullable<double> JRItemCarats { get; set; }
        public Nullable<double> JRItemLines { get; set; }
